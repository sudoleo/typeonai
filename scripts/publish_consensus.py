...
# They encode the acquisition strategy: a fresh product event as the trigger, and
# a question that still stands once that event is old. Keep in sync with
# publisher_config.py, which carries the reasoning behind the rules.
