...
def test_changed_frontend_scripts_are_cache_busted():
    ...
    assert "firebase.js?v=20260802-markdownfallback1" in template
    assert "demo.js?v=20260802-markdownfallback1" in template
    assert "usage-limit.js?v=20260802-storagebusy1" in template
    assert "query-send.js?v=20260802-storagebusy1" in template
